 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kf=1e3,Ef=2,Cf=4*60*60*1e3,Af=.5;function ds(e,t=kf,n=Ef){const r=t*Math.pow(n,e),s=Math.round(Af*r*(Math.random()-.5)*2);return Math.min(Cf,r+s)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ut(e){return e&&e._delegate?e._delegate:e}class Ce{constructor(t,n,r){this.name=t,this.instanceFactory=n,this.type=r,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(t){return this.instantiationMode=t,this}setMultipleInstances(t){return this.multipleInstances=t,this}setServiceProps(t){return this.serviceProps=t,this}setInstanceCreatedCallback(t){return this.onInstanceCreated=t,this}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bp(e){je(new Ce("platform-logger",t=>new Vf(t),"PRIVATE")),je(new Ce("heartbeat",t=>new Tp(t),"PRIVATE")),xe(yr,ms,e),xe(yr,ms,"esm2017"),xe("fire-js","")}Bp("");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yp(e,t,n){let r=1,s=null,l=null,d=!1,u=0;function p(){return u===2}let h=!1;function y(...I){h||(h=!0,t.apply(null,I))}function b(I){s=setTimeout(()=>{s=null,e(A,p())},I)}function C(){l&&clearTimeout(l)}function A(I,...M){if(h){C();return}if(I){C(),y.call(null,I,...M);return}if(p()||d){C(),y.call(null,I,...M);return}r<64&&(r*=2);let U;u===1?(u=2,U=0):U=(r+Math.random())*1e3,b(U)}let x=!1;function E(I){x||(x=!0,C(),!h&&(s!==null?(I||(u=2),clearTimeout(s),b(0)):I||(u=1)))}return b(0),l=setTimeout(()=>{d=!0,E(!0)},n),E}function Xp(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ri(e){if(!e)throw Lr()}function Em(e,t){function n(r,s){const l=Oi(e,s,t);return Ri(l!==null),l}return n}function Cm(e,t){function n(r,s){const l=Oi(e,s,t);return Ri(l!==null),xm(l,s,e.host,e._protocol)}return n}function Li(e){function t(n,r){let s;return n.getStatus()===401?n.getErrorText().includes("Firebase App Check token is invalid")?s=$p():s=Mp():n.getStatus()===402?s=Dp(e.bucket):n.getStatus()===403?s=Np(e.path):s=r,s.status=n.getStatus(),s.serverResponse=r.serverResponse,s}return t}function Am(e){const t=Li(e);function n(r,s){let l=t(r,s);return r.getStatus()===404&&(l=jp(e.path)),l.serverResponse=s.serverResponse,l}return n}function Sm(e,t,n){const r=t.fullServerUrl(),s=Mr(r,e.host,e._protocol),l="GET",d=e.maxOperationRetryTime,u=new Bi(s,l,Cm(e,n),d);return u.errorHandler=Am(t),u}function Im(e,t){return e&&e.contentType||t&&t.type()||"application/octet-stream"}function Tm(e,t,n){const r=Object.assign({},n);return r.fullPath=e.path,r.size=t.size(),r.contentType||(r.contentType=Im(null,t)),r}function Pm(e,t,n,r,s){const l=t.bucketOnlyServerUrl(),d={"X-Goog-Upload-Protocol":"multipart"};function u(){let U="";for(let J=0;J<2;J++)U=U+Math.random().toString().slice(2);return U}const p=u();d["Content-Type"]="multipart/related; boundary="+p;const h=Tm(t,r,s),y=km(h,n),b="--"+p+`\r
...
\r
`,C=`\r
--`+p+"--",A=Be.getBlob(b,r,C);if(A===null)throw Vp();const x={name:h.fullPath},E=Mr(l,e.host,e._protocol),I="POST",M=e.maxUploadRetryTime,K=new Bi(E,I,Em(e,n),M);return K.urlParams=x,K.headers=d,K.body=A.uploadData(),K.errorHandler=Li(t),K}class Om{constructor(){this.sent_=!1,this.xhr_=new XMLHttpRequest,this.initXhr(),this.errorCode_=Ge.NO_ERROR,this.sendPromise_=new Promise(t=>{this.xhr_.addEventListener("abort",()=>{this.errorCode_=Ge.ABORT,t()}),this.xhr_.addEventListener("error",()=>{this.errorCode_=Ge.NETWORK_ERROR,t()}),this.xhr_.addEventListener("load",()=>{t()})})}send(t,n,r,s){if(this.sent_)throw At("cannot .send() more than once");if(this.sent_=!0,this.xhr_.open(n,t,!0),s!==void 0)for(const l in s)s.hasOwnProperty(l)&&this.xhr_.setRequestHeader(l,s[l].toString());return r!==void 0?this.xhr_.send(r):this.xhr_.send(),this.sendPromise_}getErrorCode(){if(!this.sent_)throw At("cannot .getErrorCode() before sending");return this.errorCode_}getStatus(){if(!this.sent_)throw At("cannot .getStatus() before sending");try{return this.xhr_.status}catch{return-1}}getResponse(){if(!this.sent_)throw At("cannot .getResponse() before sending");return this.xhr_.response}getErrorText(){if(!this.sent_)throw At("cannot .getErrorText() before sending");return this.xhr_.statusText}abort(){this.xhr_.abort()}getResponseHeader(t){return this.xhr_.getResponseHeader(t)}addUploadProgressListener(t){this.xhr_.upload!=null&&this.xhr_.upload.addEventListener("progress",t)}removeUploadProgressListener(t){this.xhr_.upload!=null&&this.xhr_.upload.removeEventListener("progress",t)}}class Bm extends Om{initXhr(){this.xhr_.responseType="text"}}function ji(){return new Bm}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Mi="storage";function Nt(e,t,n){return e=ut(e),Rm(e,t,n)}function Ft(e){return e=ut(e),Lm(e)}function Ut(e,t){return e=ut(e),$m(e,t)}function Nr(e=vi(),t){e=ut(e);const r=$t(e,Mi).getImmediate({identifier:t}),s=hf("storage");return s&&Fm(r,...s),r}function Fm(e,t,n,r={}){Nm(e,t,n,r)}function Um(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),r=e.getProvider("auth-internal"),s=e.getProvider("app-check-internal");return new $r(n,r,s,t,kp)}function Hm(){je(new Ce(Mi,Um,"PUBLIC").setMultipleInstances(!0)),xe(xs,ks,""),xe(xs,ks,"esm2017")}Hm();var qm="firebase",zm="10.12.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ch(e){if(!e||!e.options)throw cr("App Configuration");if(!e.name)throw cr("App Name");const t=["projectId","apiKey","appId"];for(const n of t)if(!e.options[n])throw cr(n);return{appName:e.name,projectId:e.options.projectId,apiKey:e.options.apiKey,appId:e.options.appId}}function cr(e){return Ye.create("missing-app-config-values",{valueName:e})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const to="installations",Ah="installations-internal",Sh=e=>{const t=e.getProvider("app").getImmediate(),n=Ch(t),r=$t(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},Ih=e=>{const t=e.getProvider("app").getImmediate(),n=$t(t,to).getImmediate();return{getId:()=>xh(n),getToken:s=>kh(n,s)}};function Th(){je(new Ce(to,Sh,"PUBLIC")),je(new Ce(Ah,Ih,"PRIVATE"))}Th();xe($i,Fr);xe($i,Fr,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function eb(){if(ui())try{await fi()}catch(e){return ae.warn(ue.create("indexeddb-unavailable",{errorInfo:e==null?void 0:e.toString()}).message),!1}else return ae.warn(ue.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function tb(e,t,n,r,s,l,d){var u;const p=Jh(e);p.then(A=>{n[A.measurementId]=A.appId,e.options.measurementId&&A.measurementId!==e.options.measurementId&&ae.warn(`The measurement ID in the local Firebase config (${e.options.measurementId}) does not match the measurement ID fetched from the server (${A.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(A=>ae.error(A)),t.push(p);const h=eb().then(A=>{if(A)return r.getId()}),[y,b]=await Promise.all([p,h]);qh(l)||Mh(l,y.measurementId),s("js",new Date);const C=(u=d==null?void 0:d.config)!==null&&u!==void 0?u:{};return C[Oh]="firebase",C.update=!0,b!=null&&(C[Ph]=b),s("config",y.measurementId,C),y.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nb{constructor(t){this.app=t}_delete(){return delete It[this.app.options.appId],Promise.resolve()}}let It={},As=[];const Ss={};let dr="dataLayer",rb="gtag",Is,so,Ts=!1;function ab(){const e=[];if(vf()&&e.push("This is a browser extension environment."),wf()||e.push("Cookies are not available."),e.length>0){const t=e.map((r,s)=>`(${s+1}) ${r}`).join(" "),n=ue.create("invalid-analytics-context",{errorInfo:t});ae.warn(n.message)}}function sb(e,t,n){ab();const r=e.options.appId;if(!r)throw ue.create("no-app-id");if(!e.options.apiKey)if(e.options.measurementId)ae.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${e.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw ue.create("no-api-key");if(It[r]!=null)throw ue.create("already-exists",{id:r});if(!Ts){$h(dr);const{wrappedGtag:l,gtagCore:d}=Hh(It,As,Ss,dr,rb);so=l,Is=d,Ts=!0}return It[r]=tb(e,As,Ss,t,Is,dr,n),new nb(e)}function ib(e=vi()){e=ut(e);const t=$t(e,pn);return t.isInitialized()?t.getImmediate():ob(e)}function ob(e,t={}){const n=$t(e,pn);if(n.isInitialized()){const s=n.getImmediate();if(dn(t,n.getOptions()))return s;throw ue.create("already-initialized")}return n.initialize({options:t})}function lb(e,t,n,r){e=ut(e),Qh(so,It[e.app.options.appId],t,n,r).catch(s=>ae.error(s))}const Ps="@firebase/analytics",Os="0.10.3";function cb(){je(new Ce(pn,(t,{options:n})=>{const r=t.getProvider("app").getImmediate(),s=t.getProvider("installations-internal").getImmediate();return sb(r,s,n)},"PUBLIC")),je(new Ce("analytics-internal",e,"PRIVATE")),xe(Ps,Os),xe(Ps,Os,"esm2017");function e(t){try{const n=t.getProvider(pn).getImmediate();return{logEvent:(r,s,l)=>lb(n,r,s,l)}}catch(n){throw ue.create("interop-component-reg-failed",{reason:n})}}}cb();const db={apiKey:"AIzaSyBVpX-AHdmlRRelRhq75w56r8nH_vDujYY",authDomain:"my-profile-eeb81.firebaseapp.com",databaseURL:"https://my-profile-eeb81-default-rtdb.firebaseio.com",projectId:"my-profile-eeb81",storageBucket:"my-profile-eeb81.appspot.com",messagingSenderId:"198423650213",appId:"1:198423650213:web:b4c5bc677c06eb35ccd24c",measurementId:"G-GZBW6ZB0B4"},kn=gi(db);ib(kn);const ub=Nr(kn),Cr="jhdjfjhj",fb=({first_name:e,last_name:t,address:n,age:r,email:s,language:l,freelance:d,nationality:u,phone:p,telegram:h,avatar:y})=>`
    ...
    `,Ot=e=>{ne.fire({title:"Success!",text:e,icon:"success",showConfirmButton:!1,timer:1200,showClass:{popup:`
            ...
            `},hideClass:{popup:`
                ...
                animate__faster
            `}})},mb=()=>{document.getElementById("edit-profile").onclick=async()=>{const e=await S.get(`/infos/${Cr}.json`);document.getElementById("profile-id").value=Cr,document.getElementById("first-name").value=e.data.first_name,document.getElementById("last-name").value=e.data.last_name,document.getElementById("age").value=e.data.age,document.getElementById("freelance").value=e.data.freelance,document.getElementById("phone").value=e.data.phone,document.getElementById("telegram").value=e.data.telegram,document.getElementById("nationality").value=e.data.nationality,document.getElementById("address").value=e.data.address,document.getElementById("email").value=e.data.email,document.getElementById("language").value=e.data.language,document.getElementById("atr-img").src=e.data.avatar}},hb=()=>{document.getElementById("edit-info").onclick=async()=>{const e=document.getElementById("profile-id").value,t=document.getElementById("first-name").value,n=document.getElementById("last-name").value,r=document.getElementById("age").value,s=document.getElementById("freelance").value,l=document.getElementById("phone").value,d=document.getElementById("telegram").value,u=document.getElementById("nationality").value,p=document.getElementById("address").value,h=document.getElementById("email").value,y=document.getElementById("language").value,b=document.getElementById("avatar").files[0];if(t==""||n==""||r==""||s==""||l==""||d==""||u==""||p==""||h==""||y=="")Vr("Please, fill in all data fields");else if(b){const C=Ut(ub,"public/images/avatars/"+b.name);await Nt(C,b);const A=await Ft(C);(await S.patch(`/infos/${e}.json`,{first_name:t,last_name:n,age:r,freelance:s,phone:l,telegram:d,nationality:u,address:p,email:h,language:y,avatar:A})).status==200&&(Ot("Update successfully info"),await Ar())}else(await S.patch(`/infos/${e}.json`,{first_name:t,last_name:n,age:r,freelance:s,phone:l,telegram:d,nationality:u,address:p,email:h,language:y})).status==200&&(Ot("Update successfully info"),await Ar())}};async function bb(){const e=this.id,t=await S.get(`/skills/${e}.json`);document.querySelector("#skill-id").value=e,document.querySelector("#skill-2").value=t.data.skill,document.querySelector(`#level-2 option[value="${t.data.level}"]`).setAttribute("selected","selected")}const gb=()=>{document.querySelectorAll(".edit-skill").forEach(t=>{t.onclick=bb})},vb=()=>{document.querySelector("#edit-skill").onclick=async()=>{const e=document.querySelector("#skill-id").value,t=document.querySelector("#skill-2").value,n=document.querySelector("#level-2").value;t==""||n==""?Vr("Please, fill in all data fields"):(await S.patch(`/skills/${e}.json`,{skill:t,level:n})).status==200&&(Ot("Update successfully skill"),await En())}},wb=()=>{document.getElementById("add-skill").onclick=async()=>{const e=document.querySelector("#skill").value,t=document.querySelector("#level").value;e==""||t==""?Vr("Please, fill in all data fields"):(await S.post("/skills.json",{skill:e,level:t})).status==200&&(Ot("Add successfully skill"),document.querySelector("#skill").value="",document.querySelector("#level").value="",await En())}},yb=()=>{document.querySelectorAll(".delete-skill").forEach(t=>{t.onclick=function(){const n=this.id;ne.fire({title:"Are you sure?",text:"You will not be able to undo this action!",icon:"warning",showCancelButton:!0,confirmButtonColor:"#3085d6",cancelButtonColor:"#d33",confirmButtonText:"Delete",cancelButtonText:"Cancel"}).then(async r=>{r.isConfirmed&&(await S.delete(`/skills/${n}.json`),Ot("Delete successfully skill"),await En())})}})},Ar=async()=>{const e=await S.get(`/infos/${Cr}.json`);let t=fb(e.data);document.getElementById("infos").innerHTML=t,mb(),hb()},En=async()=>{const t=(await S.get("/skills.json")).data;let n="",r=1,s="";for(const l in t){if(Object.hasOwnProperty.call(t,l)){switch(t[l].level){case"Basic":s="bg-primary";break;case"Intermediate":s="bg-secondary";break;case"Advanced":s="bg-danger";break;case"Expert":s="bg-success";break}n+=pb(t[l],l,r,s)}r++}document.getElementById("tbody-skills").innerHTML=n,gb(),yb(),wb(),vb()},_b=async()=>{await Ar(),await En()},xb=({company_name:e,job_title:t,employment_period:n,gpa:r,job_description:s},l,d,u)=>`
    <tr>
    ...
    `,Wr=e=>{ne.fire({title:"Success!",text:e,icon:"success",showConfirmButton:!1,timer:1200,showClass:{popup:`
            ...
            `},hideClass:{popup:`
                ...
                animate__fadeOutDown
                animate__faster
            `}})};async function kb(){const e=this.id,t=await S.get(`/work_experience/${e}.json`);document.querySelector("#work_id").value=e,document.querySelector("#company-name-2").value=t.data.company_name,document.querySelector("#job-title-2").value=t.data.job_title,document.querySelector("#employment-period-2").value=t.data.employment_period,document.querySelector("#gpa-2").value=t.data.gpa,document.querySelector("#job-description-2").value=t.data.job_description}const Eb=()=>{document.querySelectorAll(".edit-experience").forEach(t=>{t.onclick=kb})},Cb=()=>{document.getElementById("edit-experience").onclick=async()=>{const e=document.querySelector("#work_id").value,t=document.querySelector("#company-name-2").value,n=document.querySelector("#job-title-2").value,r=document.querySelector("#employment-period-2").value,s=document.querySelector("#gpa-2").value,l=document.querySelector("#job-description-2").value;t==""||n==""||l==""||r==""?io("Please, fill in all data fields"):(await S.patch(`/work_experience/${e}.json`,{company_name:t,job_title:n,employment_period:r,gpa:s,job_description:l})).status==200&&(Wr("Update successfully experienced"),await Cn())}},Ab=()=>{document.getElementById("add-experience").onclick=async()=>{const e=document.querySelector("#company-name").value,t=document.querySelector("#job-title").value,n=document.querySelector("#employment-period").value,r=document.querySelector("#gpa").value,s=document.querySelector("#job-description").value;e==""||t==""||s==""||n==""?io("Please, fill in all data fields"):(await S.post("/work_experience.json",{company_name:e,job_title:t,employment_period:n,gpa:r,job_description:s})).status==200&&(Wr("Add successfully experience"),document.querySelector("#company-name").value="",document.querySelector("#job-title").value="",document.querySelector("#employment-period").value="",document.querySelector("#gpa").value="",document.querySelector("#job-description").value="",await Cn())}},Sb=()=>{document.querySelectorAll(".delete-experience").forEach(t=>{t.onclick=async function(){const n=this.id;ne.fire({title:"Are you sure?",text:"You will not be able to undo this action!",icon:"warning",showCancelButton:!0,confirmButtonColor:"#3085d6",cancelButtonColor:"#d33",confirmButtonText:"Delete",cancelButtonText:"Cancel"}).then(async r=>{r.isConfirmed&&(await S.delete(`/work_experience/${n}.json`),Wr("Delete successfully experience"),await Cn())})}})},Cn=async()=>{const t=(await S.get("/work_experience.json")).data;let n="",r=1,s="";const l=["bg-primary","bg-secondary","bg-danger","bg-success"];for(const d in t){if(Object.hasOwnProperty.call(t,d)){let u=Math.floor(Math.random()*l.length);s=l[u],n+=xb(t[d],s,d,r)}r++}document.getElementById("tbody-experience").innerHTML=n,Ab(),Sb(),Eb(),Cb()},Ib=async()=>{await Cn()},Tb=({name:e},t,n)=>`
    <tr>
        <td class="border-bottom-0">
    ...
    `,Gr=e=>{ne.fire({title:"Success!",text:e,icon:"success",showConfirmButton:!1,timer:1200,showClass:{popup:`
            ...
            `},hideClass:{popup:`
                ...
                animate__fadeOutDown
                animate__faster
            `}})};async function Pb(){const e=this.id,t=await S.get(`/categories/${e}.json`);document.getElementById("category_id").value=e,document.getElementById("category-name-2").value=t.data.name}const Ob=()=>{document.querySelectorAll(".edit-category").forEach(t=>{t.onclick=Pb})},Bb=()=>{document.getElementById("edit-category").onclick=async()=>{const e=document.getElementById("category_id").value,t=document.getElementById("category-name-2").value;t==""?oo("Please, fill in all data fields"):(await S.patch(`/categories/${e}.json`,{name:t})).status==200&&(Gr("Update successfully category"),await An())}},Rb=()=>{document.querySelectorAll(".delete-category").forEach(t=>{t.onclick=async function(){const n=this.id;ne.fire({title:"Are you sure?",text:"You will not be able to undo this action!",icon:"warning",showCancelButton:!0,confirmButtonColor:"#3085d6",cancelButtonColor:"#d33",confirmButtonText:"Delete",cancelButtonText:"Cancel"}).then(async r=>{r.isConfirmed&&(await S.delete(`/categories/${n}.json`),Gr("Delete successfully category"),await An())})}})},Lb=()=>{document.getElementById("add-category").onclick=async()=>{const e=document.getElementById("category-name").value;e==""?oo("Please, fill in all data fields"):(await S.post("/categories.json",{name:e})).status==200&&(Gr("Add successfully category"),document.getElementById("category-name").value="",await An())}},An=async()=>{const t=(await S.get("/categories.json")).data;let n="",r=1;for(const s in t)Object.hasOwnProperty.call(t,s)&&(n+=Tb(t[s],s,r)),r++;document.getElementById("tbody-categories").innerHTML=n,Lb(),Ob(),Bb(),Rb()},jb=async()=>{await An()},lo=Nr(kn),Db=({project_name:e,image:t,team_size:n,language:r,preview:s,source:l,description:d,category:u},p,h)=>`
    <tr>
        <td class="border-bottom-0">
    ...
    <div class="portfolio__item wow fadeInUp show-detail" id="${n}" data-wow-delay="0.4s">
        <img src="${t}" alt="">
    ...
    `,sg=async e=>{const t=document.querySelector(".modal");t.style.display="block";const n=await S.get(`/projects/${e}.json`),r=ag(n.data);document.querySelector(".btn__dark-light").style.display="none",document.querySelector(".modal__item").innerHTML=r},ig=()=>{document.querySelectorAll(".show-detail").forEach(t=>{t.onclick=function(){const n=this.id;sg(n)}})},og=async()=>{const t=(await S.get("/projects.json")).data;let n="";for(const r in t)Object.hasOwnProperty.call(t,r)&&(n+=Ht(t[r],r));document.querySelector("#get-all").innerHTML=n},lg=async()=>{const t=(await S.get("/projects.json")).data;let n="";for(const r in t)Object.hasOwnProperty.call(t,r)&&t[r].category=="PHP"&&(n+=Ht(t[r],r));document.querySelector("#get-php").innerHTML=n},cg=async()=>{const t=(await S.get("/projects.json")).data;let n="";for(const r in t)Object.hasOwnProperty.call(t,r)&&t[r].category=="Javascript"&&(n+=Ht(t[r],r));document.querySelector("#get-javascript").innerHTML=n},dg=async()=>{const t=(await S.get("/projects.json")).data;let n="";for(const r in t)Object.hasOwnProperty.call(t,r)&&t[r].category=="Html, Css"&&(n+=Ht(t[r],r));document.querySelector("#get-html-css").innerHTML=n},ug=async()=>{const t=(await S.get("/projects.json")).data;let n="";for(const r in t)Object.hasOwnProperty.call(t,r)&&t[r].category=="Frameworks & Libraries"&&(n+=Ht(t[r],r));document.querySelector("#get-framework").innerHTML=n},fg=async()=>{await og(),await lg(),await cg(),await dg(),await ug(),ig()},pg=({image:e,title:t,description:n},r)=>`
